<template>
  <AppLayout title="Créer un template">
    <template #header>
              ...
              <div class="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                    placeholder="Bonjour {business_name},

J'espère que vous allez bien. Je vous contacte concernant votre activité {activity_type} à {city}.
