<template>
  <AppLayout title="Créer une liste">
    <template #header>
                ...
                <div v-if="campaigns.length > 0">
                  ...
                  <div class="mt-4 p-4 bg-blue-50 rounded-lg">
                    <p class="text-sm text-blue-800">
                      💡 <strong>Exemple d'utilisation :</strong> Pour créer une liste "Pizzerias Marseille sans site web", 
                      sélectionnez la campagne "Pizzeria Marseille" et le filtre "Sans site web".
                    </p>
                  </div>
                </div>
              </div>
